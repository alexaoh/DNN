...
```{r}
# TODO (decide): Om vi väljer int4 som chosen.data behöver vi kanske skriv om lite av texten ovan. Nu låter det som att vi tar bort patienter som inte har positiv/negativ ur int3.
