...
BESKRIV LITT MER KRING HVA DE 16 BIOMEDISINSKE VARIABLENE ER (IKKE BARE KOPIERE FRA NETTSIDEN SLIK JEG HAR GJORT OVER!)
...
model2 %>% compile(loss = 'binary_crossentropy',
                  ...
                  metrics = c('accuracy'))
# train (fit)
history2 <- model2 %>% fit(data.matrix(x_train), y_train2, epochs = 40, 
              batch_size = 256, validation_split = 0.2)
# plot
plot(history2)
